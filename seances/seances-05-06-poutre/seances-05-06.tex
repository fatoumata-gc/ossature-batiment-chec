...
\textit{Moment résistant :}
\[
  M_{R_2} = \mathbf{546{,}76~\text{kN}\cdot\text{m}} > M_{B_2} = 453~\text{kN}\cdot\text{m} \quad
\]
...
\[
  M_{R_2} = \mathbf{546{,}76~\text{kN}\cdot\text{m}} > M_{t_{B_1B_2}} = 526{,}3~\text{kN}\cdot\text{m} \quad
\]
...
\]
\[
  \sigma_b^{(B_1)} = 5{,}875~\text{MPa} \leq \sigma_{R,\max}^{(B_1)} = 7{,}65~\text{MPa} \quad
\]
...
\]
\[
  \sigma_b^{(B_2)} = 4{,}05~\text{MPa} \leq \sigma_{R,\max}^{(B_2)} = 9~\text{MPa} \quad
\]
