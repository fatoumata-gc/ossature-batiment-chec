...
\textbf{Vérification :}
\encadre{$N_{Rd} = 678~\text{kN/ml} \;>\; N_{Ed} = 634~\text{kN/ml} \quad $}
...
\encadre{$\sigma_{cp} = 0{,}642~\text{MPa} \;\leq\; \sigma_{c,lim} = 5{,}934~\text{MPa} \quad $}
...
\encadre{$\sigma_{cp} = 0{,}642~\text{MPa} \;\leq\; f_{cvd} = 1{,}24~\text{MPa} \quad $}
...
\textbf{Vérification :}
\encadre{$M_{renv.} = 5\,118~\text{kN.m} \;\leq\; M_{stab.} = 15\,557~\text{kN.m} \quad $}
