...
\figureplaceholder{mur-pignon-vue-elevation}{Vue en élévation du mur pignon : longueurs et niveaux}
...
\figureplaceholder{mur-pignon-vent}{Schéma d'application de l'action du vent sur le mur pignon}
...
\figureplaceholder{mur-pignon-diagramme-rectangulaire}{Schéma du diagramme rectangulaire de contraintes utilisé pour le calcul de $A_{cc}$}
...
\figureplaceholder{mur-pignon-console-geometrie}{Géométrie de la console courte au R+1 avec efforts du vent}
...
\figureplaceholder{mur-pignon-console-bielles}{Schéma de bielles et tirants de la console courte}
...
\figureplaceholder{mur-pignon-console-ferraillage}{Ferraillage de la console courte au R+1 (tirant, aciers répartis, anti-éclatement)}
