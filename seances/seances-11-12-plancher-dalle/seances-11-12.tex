...
\figureplaceholder{plancher-dalle-vue-3d}{Vue d'ensemble du plancher-dalle étudié}
...
\figureplaceholder{plancher-dalle-vue-en-plan}{Vue en plan du plancher-dalle, file 2 dans le sens $y$, portées et console}
...
\[
\frac{6}{6} = 1 \quad\Longrightarrow\quad 0{,}8 \;\leq\; 1 \;\leq\; 1{,}25 \quad \checkmark
\]
...
\[
(CP + Q) = 3{,}5 \;\leq\; 7{,}5~\text{kN/m}^2 \quad \checkmark
\]
\[
Q = 3{,}5 \;\leq\; 2 \times 7{,}75 = 15{,}5~\text{kN/m}^2 \quad \checkmark
\]
...
\figureplaceholder{plancher-dalle-repartition-bandes}{Répartition des moments en bandes (sur poteaux et centrales)}
...
\figureplaceholder{plancher-dalle-armatures-final}{Schéma de répartition des sections d'aciers retenues, par bande}
...
\figureplaceholder{poinconnement-contour-controle}{Contour de contrôle $u_1$ et zone d'armatures de poinçonnement}
...
\encadre{$v_{Ed} = 1{,}69~\text{MPa} \;\leq\; v_{Rd,max} = 3{,}6~\text{MPa} \quad \checkmark$}
