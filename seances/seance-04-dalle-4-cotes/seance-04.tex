...
\figureplaceholder{dalle-sur-4-cotes}{Dalle sur 4 côtés au 1\textsuperscript{er} sous-sol --- vue en plan avec dimensions $l_x = 3{,}05$~m et $l_y = 5{,}85$~m}
...
\figureplaceholder{dalle-diffusion-45}{Diffusion à $45^{\circ}$ de la charge concentrée sur le feuillet moyen --- $u = u_0 + h$, $v = v_0 + h$}
...
\figureplaceholder{dalle-repartition-moments}{Répartition des moments en travée et sur appuis --- diagrammes en X et en Y}
...
\figureplaceholder{dalle-plan-ferraillage}{Plan de ferraillage de la dalle --- disposition des armatures dans les deux directions}
