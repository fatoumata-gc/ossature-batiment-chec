...
\begin{figure}[H]\centering
  \includegraphics[width=0.6\linewidth]{s9-fig01-mur-coupe.png}
  \caption{Coupe verticale du mur de sous-sol situé au droit de la file C : hauteur totale 5,40~m sur 2 niveaux (radier en bas, plancher intermédiaire à $-2{,}70$~m). Données géotechniques : $\gamma = 18$~kN/m³, $\varphi = 30^{\circ}$, $c = 0$ ; surcharge en surface $q = 10$~kN/m²}
  \label{fig:s9-mur-coupe}
\end{figure}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.95\linewidth]{s9-fig02-poussees.png}
  \caption{Diagrammes de poussée sur le mur de sous-sol : poussée triangulaire des terres ($K_a \cdot \gamma \cdot h$, à gauche) + poussée rectangulaire de la surcharge ($K_0 \cdot q$, au milieu) = poussée trapézoïdale combinée à l'ELU (à droite)}
  \label{fig:s9-poussees}
\end{figure}
...
\begin{itemize}
  \item travées de même longueur : $L_1 = L_2 = 2{,}70$~m 
  \item charges d'exploitation faibles devant les charges permanentes 
\end{itemize}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.55\linewidth]{s9-fig03-diagramme-moments.png}
  \caption{Diagramme des moments fléchissants sur les deux travées du mur (en kN·m/ml) : moment maximum en travée 1 ($14{,}03$), moment sur appui central ($31$ et $51{,}7$ selon la combinaison), moment maximum en travée 2 ($38{,}8$)}
  \label{fig:s9-moments}
\end{figure}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.55\linewidth]{s9-fig04-ferraillage.png}
  \caption{Schéma de ferraillage du mur de sous-sol : armatures verticales principales côté terre (extérieur) et armatures sur appui central côté intrados. Sections : $1{,}93$~cm²/ml (travée 1), $4{,}34$~cm²/ml (travée 2), $5{,}40$~cm²/ml (sur appui central)}
  \label{fig:s9-ferraillage}
\end{figure}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.85\linewidth]{s9-fig05-poutre-cloison-statique.png}
  \caption{Schéma statique de la poutre cloison (portée $L = 6{,}5$~m, hauteur $H = 6{,}0$~m) avec charges concentrées des poteaux supérieurs ($Q/4$, $Q/4$, $Q/4$), charge répartie $p_u = 313{,}8$~kN/ml, et modèle bielles-tirants : 2 bielles inclinées à $66{,}3^{\circ}$, tirant horizontal $F_t$, charges totales $G = 1\,120$~kN, $Q = 350$~kN}
  \label{fig:s9-poutre-statique}
\end{figure}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.55\linewidth]{s9-fig06-bielles-about.png}
  \caption{Détail de la bielle d'about de la poutre cloison : appui de largeur $0{,}5$~m, bielle inclinée formant un angle de $16{,}3^{\circ}$ avec l'horizontale, charge ponctuelle transmise $1\,018{,}5$~kN, force dans la bielle $F_b$ et tirant horizontal $F_t$}
  \label{fig:s9-bielles-about}
\end{figure}
...
Avec deux bielles, $\sigma_b = 22{,}24 / 2 = 11{,}12~\text{MPa} \leq 12{,}75~\text{MPa}$ .
