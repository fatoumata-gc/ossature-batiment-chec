...
\begin{figure}[H]\centering
  \includegraphics[width=0.95\linewidth]{s1-fig01-vue-plan-infrastructure.png}
  \caption{Vue en plan de la partie infrastructure du bâtiment : files A, B, C et 1 à 6 ; portées $L = 6{,}50$~m et $\ell = 6{,}00$~m}
  \label{fig:s1-vue-plan}
\end{figure}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.45\linewidth]{s1-fig02-dalle-nervuree-flexibilite.png}
  \caption{Dalle nervurée étudiée : $\ell_x = 3{,}25$~m, $\ell_y = 6{,}00$~m, épaisseur $h$ à déterminer}
  \label{fig:s1-dalle-flex}
\end{figure}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.55\linewidth]{s1-fig03-poutre-sec-charges.png}
  \caption{Distribution des charges sur la poutre secondaire (surfaces afférentes trapézoïdales)}
  \label{fig:s1-poutre-sec-charges}
\end{figure}

\subsubsection{Critère de résistance en flexion}

Le chargement trapézoïdal de la dalle peut être ramené à une charge linéique uniforme équivalente :

\begin{figure}[H]\centering
  \includegraphics[width=0.85\linewidth]{s1-fig04-poutre-sec-charge-equivalente.png}
  \caption{Équivalence statique : chargement trapézoïdal $\Leftrightarrow$ chargement uniforme $P_u'$}
  \label{fig:s1-poutre-sec-equiv}
\end{figure}
...
Le schéma statique de calcul de l'effort tranchant est le suivant :

\begin{figure}[H]\centering
  \includegraphics[width=0.7\linewidth]{s1-fig05-poutre-sec-effort-tranchant.png}
  \caption{Schéma statique pour le calcul de l'effort tranchant en appui ($V_0 = R_A = R_B$)}
  \label{fig:s1-poutre-sec-tranchant}
\end{figure}
...
\[
83{,}3 \;\leq\; 0{,}3 \times 20 \times 50 = 300 \quad 
\]

Vérification de la contrainte de cisaillement :

\[
\tau = \frac{3}{2} \cdot \frac{V_0}{b \, h} = \frac{3}{2} \times \frac{83{,}3}{20 \times 55} \approx 1{,}13~\text{MPa} \;\leq\; 3~\text{MPa} \quad 
\]

\subsubsection{Critère de flexibilité}

\[
h \;\geq\; \frac{L}{16} \quad\Longrightarrow\quad 55 \;\geq\; \frac{600}{16} = 37{,}5~\text{cm} \quad 
\]
...
\begin{figure}[H]\centering
  \includegraphics[width=0.55\linewidth]{s1-fig06-poutre-sec-section-T.png}
  \caption{Section en T retenue pour la poutre secondaire (cotes en mètres)}
  \label{fig:s1-poutre-sec-section}
\end{figure}
...
Pour simplifier le prédimensionnement, on retient un schéma simplifié de descente de charges (schéma B), reportant une charge concentrée au milieu de la travée principale.

\begin{figure}[H]\centering
  \includegraphics[width=0.95\linewidth]{s1-fig07-poutre-pp-distribution-charges.png}
  \caption{Schémas de distribution des charges sur la poutre principale : modèle complet (schéma A, gauche) et modèle simplifié (schéma B, droite)}
  \label{fig:s1-poutre-pp-charges}
\end{figure}
...
Le schéma statique est celui d'une poutre simplement appuyée de portée $L = 6{,}5$~m, soumise à la charge concentrée $P_t$ à mi-travée.

\begin{figure}[H]\centering
  \includegraphics[width=0.6\linewidth]{s1-fig08-poutre-pp-schema-statique.png}
  \caption{Schéma statique de la poutre principale : charge concentrée $P_t = 393{,}76$~kN sur portée $L = 6{,}50$~m}
  \label{fig:s1-poutre-pp-schema}
\end{figure}

Le moment isostatique en travée vaut :
...
\[
V_0 \;\leq\; 0{,}3 \, b_0 \, d \quad\Longrightarrow\quad 196{,}88 \;\leq\; 0{,}3 \times 30 \times 65 = 585~\text{kN} \quad 
\]
...
\[
b_0 \;\geq\; 30~\text{cm} \;\geq\; 20~\text{cm} \quad 
\]

\subsubsection{Critère de flexibilité}

\[
h = 70~\text{cm} \;\geq\; \frac{L}{16} = \frac{650}{16} \approx 40{,}63~\text{cm} \quad 
\]
...
\begin{figure}[H]\centering
  \includegraphics[width=0.55\linewidth]{s1-fig09-poutre-pp-section-T.png}
  \caption{Section en T retenue pour la poutre principale (cotes en mètres)}
  \label{fig:s1-poutre-pp-section}
\end{figure}
...
\begin{figure}[H]\centering
  \includegraphics[width=0.55\linewidth]{s1-fig10-plancher-dalle-element.png}
  \caption{Élément de plancher-dalle étudié : portée $L = 6{,}50$~m, largeur $\ell = 6{,}00$~m, épaisseur $h$ à déterminer}
  \label{fig:s1-plancher-element}
\end{figure}

Pour le dimensionnement du poteau de superstructure, on considère le poteau de la \textbf{file B au RDC}, dont la surface afférente est représentée ci-dessous :

\begin{figure}[H]\centering
  \includegraphics[width=0.5\linewidth]{s1-fig11-poteau-surface-afferente.png}
  \caption{Surface afférente du poteau de la file B (zone hachurée) : $S = 6 \times 6{,}5 = 39$~m\textsuperscript{2}}
  \label{fig:s1-poteau-S}
\end{figure}

En tenant compte de la \textbf{continuité} des travées (majoration de 15\,\%) :
