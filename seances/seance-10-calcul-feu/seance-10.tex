...
\encadre{$631{,}59~\text{kN.m} \;\geq\; M_0 = 413~\text{kN.m} \quad $}
...
\encadre{$\bar{p}_x = 17{,}31~\text{kN/ml} \;\geq\; p = 11~\text{kN/ml} \quad $}
\encadre{$\bar{p}_y = 16{,}65~\text{kN/ml} \;\geq\; p = 11~\text{kN/ml} \quad $}
