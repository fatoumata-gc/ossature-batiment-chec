...
Vérification de stabilité                         & $N_{Ed} < N_{Rd}$ \quad $$ \\
...
~~Vérification $M_{Rt} + (M_{Re}+M_{Rw})/2 \geq M_0$    & $631{,}59 \geq 413$~kN.m \quad $$ \\
\midrule
...
~~Vérification                                          & $\bar{p}_x, \bar{p}_y \geq p$ \quad $$ \\
\bottomrule
\end{tabularx}
...
~~Vérification au nu du poteau                          & $v_{Ed} = 1{,}69 \leq v_{Rd,max} = 3{,}6$~MPa \quad $$ \\
\bottomrule
\end{tabularx}
